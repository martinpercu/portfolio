...
@Component({
  selector: 'app-certifications-storage',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './certifications-storage.component.html',
  styleUrl: './certifications-storage.component.css'
})
export class CertificationsStorageComponent {
  ...
  async ngOnInit() {
    ...
    this.route.paramMap.pipe(
      switchMap(params => {
        ...
        const pdfRef = ref(this.storage, `certifications/${this.certificationNamePdf}.pdf`);
